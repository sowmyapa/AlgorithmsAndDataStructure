...
public class lexicographicString {
	 ...
	 public static void main(String[] args) {
	        ...
	        String output = A.compareTo(B)>0?"Yes":"No";
	        System.out.println(output);

	        if(A.length()>0){
	        	stringBuilder.append(Character.toTitleCase(A.charAt(0))).append(A.substring(1));
	        }
	        if(B.length()>0){
	        	stringBuilder.append(" ").append(Character.toTitleCase(B.charAt(0))).append(B.substring(1));
	        }
